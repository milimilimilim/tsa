...
tsa0 = tsa_class.LoadingInputValue()
#tsa0.loading_ini()
tsa1 = tsa_class.SurfaceFireProofing(tsa0)
tsa2 = tsa_class.FpToFp(tsa0)
tsa3 = tsa_class.FpTerminal(tsa0)
tsaC = tsa_class.StabilityAnalysis(tsa0)
# print(tsa1.temperature_furnace(10))
print(tsa1.cal_temperature_max())
...
classesA = []
classesA.append(tsa_class.TestTsa(1, 'テスト１'))
classesA.append(tsa_class.TestTsa(2, 'テスト２'))
